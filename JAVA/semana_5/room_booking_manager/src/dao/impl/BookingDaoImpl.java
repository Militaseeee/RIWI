...
public class BookingDaoImpl implements BookingDao {
    ...
    public void create(Booking object) throws DataAccessException {
        ...
        try(Connection connection = DbConfig.getConnection();
            ...
            preparedStatement.setInt(1, object.getIdRoom());
    ...
    public List<Booking> findAll() throws DataAccessException {
        ...
        try (Connection objConnection = DbConfig.getConnection();
            ...
            e.printStackTrace(); // Esto mostrará el mensaje SQL exacto
    ...
    public void delete(int id) throws DataAccessException {
        ...
        try (Connection connection = DbConfig.getConnection();
            ...
            if (affectedRows == 0) {
                ...
                System.err.println("Warning: No booking found with ID " + id + " to delete");
            }
