...
//            }
    ...
    public void listAllProducts() {
        ...
        List<Product> listProduct = this.objProductModel.findAll();
    ...
    private String generateProductListString() {
        List<Product> products = this.objProductModel.findAll();
        if (products.isEmpty()) {
            return "No products available.";
        }
        StringBuilder listString = new StringBuilder("Available Products:\n");
        for (Product product : products) {
            listString.append(product.toString()).append("\n");
        }
    ...
    public void deleteProduct() {
        ...
        try {
            ...
            if (this.objProductModel.delete(tempProduct.getId())) {
                this.deletesCounter++;
